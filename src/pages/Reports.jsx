...
import { BarChart2, Printer, ChevronDown, Users, Truck, FileText } from 'lucide-react'
import toast from 'react-hot-toast'
import PageHeader from '../components/PageHeader'
import EmptyState from '../components/EmptyState'
import { ClientBillPrint, VendorBillPrint } from '../components/BillPrint'
...
export default function Reports() {
  ...
  function clearFilters() { setClientId(''); setVendorId(''); setDate(''); setResults([]) }
